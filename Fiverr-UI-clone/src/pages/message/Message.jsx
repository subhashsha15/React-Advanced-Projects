    ...
    <div className="message">
      <div className="message-container">
        ...
        <div className="message-container-messages">
          ...
          <div className="message-container-messages-item owner">
            <img
        ...
        <hr />
        <div className="message-container-write">
